...
struct RawData
{
    int16_t ax, ay, az, gx, gy, gz, mx, my, mz ;  //accel[3],gyro[3], magnet[3]
...
#define resetval 	 0x80
#define  wakeval   	 0x00
#define  closeval    0x00
#define  modebypass  0x82
#define  clesel      0x01
#define  signlemes   0x11


//如果AD0脚(9脚)接地,IIC地址为0X68(不包含最低位).
//如果接V3.3,则IIC地址为0X69(不包含最低位).
#define MPU9250_ADDR            (0X68<<1)    //MPU6500的器件IIC地址
...
// Constants
#define  aScaleFactor  16384.0
#define  gScaleFactor  65.5
#define  RAD2DEG 	   57.2957795131

extern	uint16_t gyro[3], accel[3],magnet[3];
extern struct RawData rawData ;
extern struct GyroCal gyroCal ;
extern uint16_t *p_gyro ;
extern uint16_t *p_accel ;
extern uint16_t *p_magnet ;
